...
|---|---|---|---|---|---|---|---|---|
| S01 | Design + estrutura visual + docs aprovadas | res/ (colors/styles/2 layouts) + manifest + tests pre | RNF-01 | aapt2/XML | UC-02 (estrutura) | T-S01-01..03 | docs/reports/S01.md | ready |
| S02 | App funcional + build CI verde | 2 Activities Java + unsigned.apk no CI | RF-01, RF-02 | Java/aapt2/make | UC-01, UC-02 | T-S02-01..02 | docs/reports/S02.md | blocked |
